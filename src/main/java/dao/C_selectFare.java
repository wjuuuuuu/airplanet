...
public class C_selectFare {
	...
	public List<FareAll> getFareList(FareAll sch) {
		...
		String sql = "SELECT f.totalPrice, a.airlineName, f.bookingReference, f.resDate, f.resState, fl.departAirport, fl.arriveAirport, fl.flightNumber, fl.departDate, fl.flightHours, LISTAGG(p.korname, ',') WITHIN GROUP(ORDER BY korname) AS korname, ar.phonenumber, ar.email \r\n"
				...
				+ "f.bookingReference = ? \r\n"
				+ "GROUP BY f.totalPrice, a.airlineName, f.bookingReference, f.resDate, f.resState, fl.departAirport, fl.arriveAirport, fl.flightNumber, fl.departDate, fl.flightHours,ar.phonenumber, ar.email";
